...
+ (void) frameAndShadow: (UIView *) view andFrameColor: (UIColor *) color
//Shadow is all Over with a white frame
{
    CALayer *layer = view.layer;
    [layer setBorderColor: [color CGColor]]; //Frame Color
    [layer setBorderWidth:1.0f]; //Frame Border
    [layer setShadowColor: [[UIColor grayColor] CGColor]]; //Shadow Color
    [layer setShadowOpacity:0.60f];
...
+ (void) shadowOnView: (UIView *) view andShadowType: (NSString *) shadowType andShadowColor: (UIColor *) color{
